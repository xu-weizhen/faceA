...
class Ui_Form_main(object):
    def setupUi(self, Form_main):
        ...
        self.pushButton_p.setGeometry(QtCore.QRect(280, 320, 180, 40))
        ...
        self.pushButton_7.setGeometry(QtCore.QRect(40, 370, 180, 40))
